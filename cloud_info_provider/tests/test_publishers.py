...
class AMSPublisherTest(base.TestCase):
    def test_populate_parser(self):
        ...
        opts = parser.parse_args(["--ams-token", "foo",
                                  "--ams-host", "example.com",
                                  "--ams-topic", "foobar",
                                  "--ams-project", "bar",
                                  "--ams-cert", "baz",
                                  "--ams-key", "secret"])
    ...
    def test_get_token(self):
        ...
        with mock.patch("requests.get") as m_get:
            ...
            url = ("https://example.com:8443/v1/service-types/ams/hosts/"
    ...
    def test_publish(self):
        ...
        with utils.nested(
                ...
                mock.patch.object(publisher, "_get_ams_token")
