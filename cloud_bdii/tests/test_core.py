...
class BaseTest(unittest.TestCase):
    old_supported_middleware = None
    def setUp(self):
#        self.old_supported_middleware = cloud_bdii.core.SUPPORTED_MIDDLEWARE
...
#    def tearDown(self):
#        if self.old_supported_middleware is None:
#            return
#
#        cloud_bdii.core.SUPPORTED_MIDDLEWARE = self.old_supported_middleware
