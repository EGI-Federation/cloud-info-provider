...
Dynamic information is obtained with the middleware providers (e.g. OpenStack,
ooi, OpenNebula via rOCCI). Use the `--middleware` option for specifying the
provider to use (see the command help for exact names).
